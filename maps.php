...
<body>
    ...
    <h1 style="font-size: 20px;margin: auto; color: black; display: flex; align-content: center; justify-content: center;">"MY MAP"</h1><br>

    <a href="home.php" style="position:fixed; bottom:70px; right: 100px" >BACK</a>
            ...
            ajaxRequest.onreadystatechange = function() {
               ...
               for (let i in response) {
                  ...
                  var marker = L.marker([response[i].latitude, response[i].longtitude], {draggable: false, icon: myIcon})
                              .bindPopup("<h3>"+response[i].name + '<br><br><h4><a href="checkin.php" >Insert Visit</a></h4>'+
                              "</h3><br>Εκτιμώμενη επισκεψιμότητα: " + min + " - " + max )
...
<!--<button onClick={logout} ><a href="checkin.php" >Insert Visit</a>'
'<form action="checkin-check.php" method="post"><input type="checkbox" name="visit" value="visit" style="width: auto;" >Confirm Visit '+
                              '<br><input type="integer" name="amount" placeholder="Enter amount"></form>' +
